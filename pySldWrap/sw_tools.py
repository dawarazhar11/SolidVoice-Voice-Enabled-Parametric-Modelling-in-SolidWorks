...
def create_new_part(path):
    """
    Creates a new part and saves it to the specified path.

    Args:
        path (str): The path to save the part.

    Returns:
        The newly created part as a Model object.
    """
